...
export const ObGynWorkspace: React.FC = () => {
  ...
  const dashboardFeatures = [
    ...
    },
    {
      ...
      description: 'Manage your AI-powered document storage with semantic search and intelligent organization',
      icon: Database,
    ...
    },
    {
      id: 'medical-forms',
      title: 'Medical Forms',
      subtitle: 'Digital Documentation',
      description: 'Access OB/GYN-specific forms, templates and automated documentation workflows',
      icon: ClipboardList,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-violet-400/5 to-pink-600/5 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
