    ...
    switch (specialty) {
      case 'cardiology':
        return {
          ...
          title: 'Cardiology AI Expert',
          subtitle: 'Advanced cardiovascular care assistance'
        };
      case 'obgyn':
        return {
          icon: User,
          ...
          title: 'OB/GYN AI Expert',
          subtitle: 'Women\'s health & reproductive medicine'
        };
      default:
        return {
          icon: Stethoscope,
          ...
          subtitle: 'Comprehensive healthcare assistance'
        };
    }
  };
  ...
  const quickActions = [
    {
      ...
      description: 'Start analyzing a patient case with AI assistance',
      icon: FileText,
      gradient: 'from-blue-500 to-indigo-600',
    ...
    },
    {
      ...
      description: 'Access clinical calculators and risk assessments',
      icon: Calculator,
    ...
    },
    {
      ...
      description: 'Search evidence-based medical protocols',
      icon: BookOpen,
    ...
    },
    {
      ...
      description: 'Begin a medical consultation with AI',
      icon: MessageSquare,
  ...
  const features = [
    {
      ...
      description: 'Advanced medical reasoning and decision support'
    },
    {
      icon: Globe,
      title: 'Evidence-Based',
      description: 'Curated from 2.5M+ medical sources and guidelines'
    },
    {
      icon: Zap,
      title: 'Real-Time Assistance',
      description: 'Instant responses for clinical decision making'
    },
    {
      icon: Star,
      title: 'Specialty Focused',
      description: 'Tailored expertise for your medical specialty'
    }
  ];
      ...
      <div className="relative flex-1 flex flex-col items-center justify-center p-8 space-y-12">
        ...
        <div className="text-center space-y-6 max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            `}>
              Welcome to {specialtyConfig.title}
            </h1>
            ...
            <div className="flex items-center justify-center space-x-4 text-sm text-slate-500">
              <div className="flex items-center space-x-2">
                ...
                <span>Live at {currentTime.toLocaleTimeString()}</span>
              </div>
              <span>•</span>
              <div className="flex items-center space-x-2">
          ...
          <div className="w-full max-w-4xl">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-slate-800">
                Recent Cases ({caseHistory.length})
              </h3>
              <Button
                variant="outline"
                size="sm"
        ...
        <div className="text-center">
          <p className="text-sm text-slate-500 mb-4">
            Start by typing a message below or selecting an action above
          </p>
