...
export const KnowledgeBaseSelector: React.FC<KnowledgeBaseSelectorProps> = ({
  ...
  const knowledgeBaseOptions = [
    {
      ...
      description: 'Medical guidelines, research & evidence-based protocols',
      icon: Globe,
      color: {
    ...
    },
    {
      ...
      description: 'Your uploaded documents, notes & clinical references',
      icon: User,
      color: {
      ...
      badge: personalDocumentCount > 0 ? 'Ready' : 'Empty',
      count: personalDocumentCount > 0 
        ? `${personalDocumentCount} document${personalDocumentCount === 1 ? '' : 's'}`
        : 'Upload to enable'
    }
  ];
  ...
  const handleSelect = (type: KnowledgeBaseType) => {
    if (type === 'personal' && personalDocumentCount === 0) return;
                        ...
                        {option.type === 'curated' && (
                          <>
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-sm text-blue-600 font-semibold">AI Verified</span>
                            </div>
                          </>
                        )}
                      </div>
            ...
            <div className="mt-3 p-4 rounded-2xl bg-gradient-to-r from-slate-50/80 to-white/80 border border-slate-200/40 backdrop-blur-sm">
              <div className="flex items-center space-x-3 text-sm text-slate-600">
                ...
                <span className="font-medium">
                  Knowledge base selection influences AI response accuracy and information depth
                </span>
              </div>
            </div>
          </div>
