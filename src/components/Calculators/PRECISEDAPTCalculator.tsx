...
import { Calculator, Info, AlertTriangle, Clock, Shield, TrendingDown, Droplets, Activity, User, FileText, Target, Stethoscope, Award, BarChart3, Brain, Heart, Thermometer, Zap, CheckCircle2 } from 'lucide-react';
import { 
  CalculatorContainer, 
  CalculatorInput, 
  CalculatorSelect, 
