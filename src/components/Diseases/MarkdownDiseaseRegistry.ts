...
export const markdownDiseaseRegistry: MarkdownDiseaseItem[] = [
  ...
  },
  {
    ...
    markdownFile: '/diseases/A-Fib.md',
  ...
  },
  {
    ...
    category: 'Valvular Heart Disease',
    description: 'Management of mechanical and bioprosthetic heart valves.',
    tags: ['Valvular Disease', 'Prosthetic', 'Anticoagulation', 'Surgery'],
    severity: 'high',
    readTime: '35 min',
    lastUpdated: 'May 31, 2025',
    markdownFile: '/diseases/prosthetic-heart-valves-chunk1.md',
    prevalence: '50 per 100,000',
    specialty: 'cardiology'
  },
  {
