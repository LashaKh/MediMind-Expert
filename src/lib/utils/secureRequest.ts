...
export const secureAPI = {
  get: <T = any>(url: string, options?: SecureRequestOptions) =>
    secureRequest<T>(url, { ...options, method: 'GET', requireCSRF: false }),

  post: <T = any>(url: string, data?: any, options?: SecureRequestOptions) =>
    secureRequest<T>(url, {
      ...options,
      method: 'POST',
      headers: {
  ...
  put: <T = any>(url: string, data?: any, options?: SecureRequestOptions) =>
    secureRequest<T>(url, {
      ...options,
      method: 'PUT',
      headers: {
  ...
  delete: <T = any>(url: string, options?: SecureRequestOptions) =>
    secureRequest<T>(url, { ...options, method: 'DELETE' }),

  patch: <T = any>(url: string, data?: any, options?: SecureRequestOptions) =>
    secureRequest<T>(url, {
      ...options,
      method: 'PATCH',
      headers: {
