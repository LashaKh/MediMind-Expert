export const pretermBirthRiskCalculator = {
  ...
  tool_description: "სპონტანური ადრეული მშობიარობის კომპლექსური რისკის სტრატიფიკაცია კლინიკური რისკის ფაქტორების, საშვილოსნოს ყელის სიგრძის შეფასების და ბიომარკერების გამოყენებით. მართავს პრევენციულ ჩარევებს და მონიტორინგის პროტოკოლებს.",
  ...
  ffn_info_2: "საუკეთესოა გამოიყენოს საშვილოსნოს ყელის სიგრძის შეფასებასთან ერთად",
  ffn_info_3: "ოპტიმალური დრო: 22-34 კვირა ორსულობისა სიმპტომური პაციენტებისთვის",
  
  // Risk Factors Section
  historical_risk_factors: "ისტორიული რისკის ფაქტორები",
  ...
  multiple_gestation: "მრავალტყუპა ორსულობა",
  multiple_gestation_help: "მიმდინარე ორსულობა ტყუპებით, სამეულებით ან უფრო მაღალი რიგის მრავალტყუპობით",
  ...
  high_impact_info_3: "მრავალტყუპა ორსულობა შეადგენს ~15% ადრეული მშობიარობისა",
  ...
  modifiable_info_3: "განიხილეთ საშვილოსნოს ყელის ცერკლაჟი სპეციფიკური ანატომიური რისკებისთვის",
  
  // Risk Assessment Framework
  risk_assessment_framework: "რისკის შეფასების ჩარჩო",
  framework_info_1: "რისკის სტრატიფიკაცია მართავს პრევენციულ ჩარევებს და მონიტორინგის ინტენსივობას",
  framework_info_2: "აერთიანებს კლინიკურ რისკის ფაქტორებს საშვილოსნოს ყელის სიგრძის და ბიომარკერების შეფასებასთან",
  framework_info_3: "მტკიცებულებაზე დაფუძნებული მიდგომა პროგესტერონული თერაპიისა და გაძლიერებული ზედამხედველობის გადაწყვეტილებებისთვის",
