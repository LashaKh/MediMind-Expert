export const preeclampsiaRiskCalculator = {
  ...
  multiple_gestation: "მრავალნაყოფა ორსულობა (ტყუპები/სამეული)",
  
  // Moderate Risk Factors
  nulliparity: "პირველმშობიარე (პირველი ორსულობა)",
  maternal_age_35: "დედის ასაკი ≥35 წელი",
  family_history_preeclampsia: "ოჯახური ანამნეზი პრეეკლამფსიისა",
  obesity_bmi_30: "სიმსუქნე (BMI ≥30 კგ/მ²)",
  previous_adverse_outcome: "წინა უარყოფითი ორსულობის შედეგი",
  interpregnancy_interval: "ორსულობებს შორის ინტერვალი >10 წელი",
  ivf_pregnancy: "IVF/დახმარებული რეპროდუქცია",
  ...
  aspirin_recommendation: "დაბალი დოზის ასპირინის რეკომენდაცია",
  monitoring_recommendations: "მონიტორინგის რეკომენდაციები",
  ...
  high_risk_description: "პრეეკლამფსიის განვითარების მაღალი რისკი. ძლიერი რეკომენდაცია დაბალი დოზის ასპირინის პროფილაქტიკისა და გაძლიერებული მონიტორინგისთვის.",
  ...
  aspirin_indicated: "დაბალი დოზის ასპირინი (81მგ დღეში) რეკომენდებული",
  ...
  meta_analysis_data: "მეტა-ანალიზი აჩვენებს მნიშვნელოვან შემცირებას მძიმე პრეეკლამფსიაში",
  ...
  no_specific_recommendation: "კონკრეტული რეკომენდაცია არა",
  ...
  about_clinical_purpose_description: "პრეეკლამფსიის რისკის კალკულატორი უზრუნველყოფს მტკიცებულებაზე დაფუძნებულ პრეეკლამფსიის რისკის შეფასებას კლინიკური რისკის ფაქტორებისა და დამატებითი ბიომარკერების გამოყენებით. ის ეხმარება ასპირინის პროფილაქტიკური გადაწყვეტილებების მიღებაში USPSTF და ACOG რეკომენდაციების შესაბამისად.",
  ...
  clinical_calculator_notice: "ეს კალკულატორი უზრუნველყოფს მტკიცებულებაზე დაფუძნებულ რისკის შეფასებას კლინიკური გადაწყვეტილების მისაღებად. ყოველთვის გაითვალისწინეთ ინდივიდუალური პაციენტის ფაქტორები, უკუჩვენებები და კლინიკური განსჯა.",
