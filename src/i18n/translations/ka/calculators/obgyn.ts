export const obgynCalculators = {
  ...
  endometrialCancerRisk: {
    ...
    description: 'ენდომეტრიუმის კიბოს რისკის შეფასება მტკიცებულებებზე დაფუძნებული ფაქტორების გამოყენებით',
  ...
  gestationalAge: {
    ...
    description: 'გესტაციური ასაკის ზუსტი გამოთვლა ბოლო მენსტრუაციის თარიღის ან ექოსკოპიის მონაცემების საფუძველზე',
  ...
  pregnancyWeightGain: {
    title: 'ორსულობის დროს წონის მატების კალკულატორი',
    description: 'ორსულობის დროს ჯანსაღი წონის მატების რეკომენდაციები BMI-ის საფუძველზე',
  ...
  pregnancyBmi: {
    title: 'ორსულობის BMI კალკულატორი',
    description: 'ორსულობის წინა BMI-ის გამოთვლა და კატეგორიზაცია რისკის შეფასებისთვის',
  ...
  edd: {
    ...
    description: 'მშობიარობის სავარაუდო თარიღის გამოთვლა ბოლო მენსტრუაციის თარიღის საფუძველზე',
  ...
  apgarScore: {
    title: 'აპგარის ქულების კალკულატორი',
    description: 'ახალშობილის ფიზიოლოგიური მდგომარეობის შეფასება აპგარის 5-კომპონენტიანი სისტემით',
  ...
  fetalWeightEstimation: {
    ...
    description: 'ნაყოფის სავარაუდო წონის გამოთვლა ულტრაბგერითი ბიომეტრიის საფუძველზე',
  ...
  cervicalLength: {
    ...
    description: 'საშვილოსნოს ყელის სიგრძის მომეტრია ნაადრევი მშობიარობის რისკის შეფასებისთვის',
  ...
  epds: {
    ...
    description: 'მშობიარობის შემდგომი დეპრესიის სკრინინგი ედინბურგის სტანდარტიზებული კითხვარით',
  ...
  preeclampsiaRisk: {
    ...
    description: 'პრეეკლამფსიის რისკის კომპრეჰენსიული შეფასება დედობრივი და ორსულობის ფაქტორების საფუძველზე',
  ...
  laborProgress: {
    ...
    description: 'მშობიარობის პროცესის პროგრესის შეფასება და პროგნოზირება მონიტორინგის პარამეტრების საფუძველზე',
  ...
  ovarianCancerRisk: {
    title: 'საკვერცხის კიბოს რისკის კალკულატორი',
    description: 'საკვერცხის კიბოს რისკის შეფასება გენეტიკური და გარემო ფაქტორების გათვალისწინებით',
  ...
  cervicalCancerScreening: {
    title: 'საშვილოსნოს ყელის კიბოს სკრინინგი',
    description: 'საშვილოსნოს ყელის კიბოს სკრინინგის რეკომენდაციები ასაკისა და რისკის ფაქტორების მიხედვით',
