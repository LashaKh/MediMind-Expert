export default {
  ...
  risk_by_age_description: 'რისკის შეფასებები ასაკის მიხედვით იგივე რისკ ფაქტორების მქონე ინდივიდებისთვის',
  age_years: 'ასაკი (წლები)',
  risk_percentage: 'რისკი (%)',
  age: 'ასაკი',
  years: 'წლები',
  risk_insights: 'რისკის ანალიზი',
  current_age: 'ამჟამინდელი ასაკი',
  year_total_risk: 'წლიური მთლიანი რისკი',
