...
export const diseaseIndex: DiseaseIndexItem[] = [
  ...
  },
  {
    ...
    category: 'Cardiomyopathy',
    lastUpdated: 'January 18, 2025 - COMPREHENSIVE MODULAR STRUCTURE',
    readTime: '90 min',
    severity: 'high',
    description: 'A comprehensive genetic cardiomyopathy resource with complete modular structure covering background, clinical findings, diagnostic investigations, medical management, surgical interventions, special populations, and evidence-based guidelines. Includes 21 medical references and landmark clinical trials (SEQUOIA-HCM, EXPLORER-HCM).',
    tags: ['Cardiomyopathy', 'Genetic', 'LVH', 'Sudden Death', 'Family Screening', 'HCM Risk-SCD', 'Myectomy', 'ICD', 'Mavacamten', 'Aficamten', 'ACC/AHA', 'ESC', 'HRS', 'Comprehensive'],
